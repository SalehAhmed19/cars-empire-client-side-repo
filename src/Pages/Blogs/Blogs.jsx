...
const Blogs = () => {
  return (
    <div>
      <h2 className="text-center fw-bold py-3">Blogs</h2>
      <div className="font-4">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    ...
                    several fundamental libraries that JavaScript programmers
                ...
                <tr>
                  ...
                  <td>
                    Only the V8 engine, which is mostly used by Google Chrome,
                    can run Node JS. And any javascript programs developed with
                    Node JS will always run in the V8 Engine.
                  </td>
                </tr>
              </tbody>
            </Table>
        ...
        <div className="bg-light p-3 border rounded-3 m-3">
          ...
          <div>
            ...
            <p>
              <strong>MongoDB</strong> is a multi-purpose database that is used
              in a variety of industries to support applications. Because it
              tackles long-standing issues in data management and software
              development, MongoDB has found a home in a variety of enterprises
              and functions. MongoDB has a wide range of applications.
            </p>
          </div>
        </div>
      </div>
